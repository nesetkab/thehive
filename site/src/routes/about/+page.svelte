<script lang="ts">
  ...
  const toggle = (year: string) => { openYear = openYear === year ? null : year; };

  const banners = [
    { src: '/banners/2023-inspire.svg', label: '2023 · Inspire Award' },
    { src: '/banners/2023-winner.svg',  label: '2023 · Winning Alliance' },
    { src: '/banners/2024-inspire.svg', label: '2024 · Inspire Award' },
    { src: '/banners/2024-winner.svg',  label: '2024 · Winning Alliance' },
    { src: '/banners/2025-inspire.svg', label: '2025 · Inspire Award' },
  ];

  type Event = { name: string; awards: string[] };
  type Season = { year: string; events: Event[] };

  const seasons: Season[] = [
    {
      year: '2025',
      events: [
        { name: 'UT-Beehive Scrimmage', awards: ['Winning Alliance — 1st Team Selected'] },
        { name: 'Treasure Valley FTC Qualifying Event', awards: ['Think Award', 'Winning Alliance — Captain'] },
        { name: 'Freedom Preparatory Academy Qualifier', awards: ['Finalist Alliance — Captain', 'Inspire Award'] },
        { name: 'Hurricane Qualifier', awards: ['Think Award', 'Winning Alliance — Captain'] },
        { name: 'Freedom Preparatory Academy Scrimmage', awards: ['Winning Alliance — Captain'] },
        { name: 'Hillcrest Husky STEAM Labs Qualifier', awards: ['FIRST® Leadership Award Semi-Finalists', 'Think Award', 'Winning Alliance — Captain'] },
        { name: 'Utah Championship', awards: ['FIRST® Leadership Award Finalists', 'Compass Award', 'Finalist Alliance — 1st Team Selected', 'Inspire Award'] },
        { name: 'FIRST Championship — Jacks Division', awards: ['Innovate Award sponsored by RTX, 2nd Place'] },
        { name: 'FIRST Championship — FIRST Tech Challenge', awards: [] },
      ],
    },
    {
      year: '2024',
      events: [
        { name: 'Beehive Academy Checkpoint Scrimmage', awards: ['Finalist Alliance — 1st Team Selected'] },
        { name: 'Freedom Prep Qualifier', awards: ['Finalist Alliance — 1st Team Selected', 'Inspire Award'] },
        { name: 'Hurricane High Qualifier', awards: ['Innovate Award sponsored by RTX', 'Winning Alliance — 1st Team Selected'] },
        { name: 'FPA Phoenix Qualifier', awards: ['Connect Award, 2nd Place', 'Design Award', 'Winning Alliance — Captain'] },
        { name: 'Park City Qualifier', awards: ['Connect Award', 'Winning Alliance — Captain'] },
        { name: 'Utah Championship', awards: ["Dean's List Finalists", 'Inspire Award', 'Volunteer Award', 'Winning Alliance — Captain'] },
        { name: 'FIRST Championship — Franklin Division', awards: ['Motivate Award, 3rd Place'] },
        { name: 'FIRST Championship — FIRST Tech Challenge', awards: [] },
      ],
    },
    {
      year: '2023',
      events: [
        { name: 'UT Freedom Prep Academy Qualifier', awards: ['Connect Award, 2nd Place', 'Innovate Award sponsored by RTX'] },
        { name: 'UT Hurricane High School Qualifier', awards: ['Inspire Award', 'Winning Alliance — Captain'] },
        { name: 'UT American Academy of Innovation Qualifier', awards: [] },
        { name: 'UT Park City High School Qualifier', awards: ['Control Award', 'Motivate Award, 2nd Place', 'Winning Alliance — Captain'] },
        { name: 'Utah FTC Championship', awards: ['Connect Award, 3rd Place', 'Inspire Award', 'Winning Alliance — Captain'] },
        { name: 'FIRST Championship presented by BAE Systems', awards: [] },
      ],
    },
    {
      year: '2022',
      events: [
        { name: 'UT Freedom Prep Academy Qualifier', awards: [] },
        { name: 'UT American Academy of Innovation Qualifier', awards: [] },
        { name: 'UT AAI 2nd Qualifier', awards: ['Design Award', 'Think Award, 3rd Place'] },
        { name: 'Utah Championship', awards: [] },
      ],
    },
    {
      year: '2021',
      events: [
        { name: 'UT Freedom Prep Academy Qualifier', awards: ['Winning Alliance — 1st Team Selected'] },
        { name: 'UT American Academy of Innovation Qualifier', awards: ['Innovate Award sponsored by Raytheon Technologies, 3rd Place', 'Winning Alliance — 1st Team Selected'] },
        { name: 'Utah Championship at Southern Utah University', awards: [] },
        { name: 'Idaho State Championship', awards: [] },
      ],
    },
    {
      year: '2020',
      events: [
        { name: 'UT FTC West High School Qualifier', awards: ["Judges' Award"] },
        { name: 'UT FTC Freedom Prep Academy Qualifier', awards: ['Design Award, 2nd Place', 'Inspire Award', 'Motivate Award, 2nd Place', 'Winning Alliance — Captain'] },
        { name: 'UT FTC American Academy of Innovation Qualifier', awards: ['Design Award', 'Finalist Alliance — Captain'] },
        { name: 'UT FTC State Championship', awards: ['Finalist Alliance — 1st Team Selected'] },
      ],
    },
    {
      year: '2019',
      events: [
        { name: 'West High Qualifier', awards: ['Compass Award'] },
        { name: 'Park City Qualifier', awards: ['Collins Aerospace Innovate Award, 3rd Place'] },
        { name: 'Southern Utah University Qualifier', awards: ['Connect Award, 3rd Place', 'Design Award, 3rd Place', 'Inspire Award, 3rd Place'] },
        { name: 'FIRST Tech Challenge Wyoming State Championship', awards: ['Collins Aerospace Innovate Award', 'Finalist Alliance — Captain'] },
        { name: 'FTC UT State Championship', awards: [] },
      ],
    },
  ];
</script>
...
<main class="flex min-h-screen flex-col px-5 sm:px-10 lg:px-16 pt-24 sm:pt-40 pb-20 sm:pb-24 max-w-5xl mx-auto">
  ...
  <section class="flex flex-col gap-6 mb-20 sm:mb-24 max-w-3xl rise" style="animation-delay:460ms">
    <p class="text-foreground/60 leading-relaxed text-lg">
      ...
      work, and give back to the communities that shaped them.
    </p>
  </section>
    ...
    <div class="grid grid-cols-5 gap-1.5 sm:gap-4 items-end">
      {#each banners as b, i}
        <img
          src={b.src}
          alt={b.label}
          class="block w-full h-auto transition-transform duration-300 hover:-translate-y-1 drop-shadow-[0_18px_30px_rgba(250,90,0,0.18)] rise"
      ...
      {#each seasons as season}
        ...
        <div class="border-t border-foreground/10 last:border-b">
          ...
          >
            ...
            <span
              class="text-foreground/40 text-sm select-none transition-transform duration-300 ease-out"
                  ...
                  {#if event.awards.length}
                    <ul class="flex flex-col gap-1 pl-0">
                      {#each event.awards as award}
                        <li class="text-foreground/60 text-sm flex gap-3">
  ...
  <section class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 py-12 border-t border-foreground/10">
    <div class="flex flex-col gap-2 max-w-md">
      <h2 class="text-2xl sm:text-3xl font-light">Want to know more?</h2>
      <p class="text-foreground/60">Reach out — we'd love to hear from you.</p>
    </div>
    <a href="/contact" class="text-foreground hover:text-accent transition-colors text-lg whitespace-nowrap">
      Contact us →
    </a>
  </section>
</main>

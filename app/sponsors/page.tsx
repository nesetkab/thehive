  ...
  return (
    <main className="flex  flex-col items-center justify-between ">
      ...
      <div className="mt-12 px-24 hidden lg:flex self-stretch  place-items-start  flex-row">
        ...
        <div className="">
          <div className="pl-12  flex flex-nowrap flex-row justify-between">
            ...
            <div className="p-4 ml-8 group rounded-lg border border-transparent transition-colors border-yellow bg-gray-100 border-neutral-100 bg-neutral-800/30 ">

    ...
    <main className="flex min-h-screen min-w-screen  flex-col items-center overflow-x-clip pt-4 md:pt-12  text-gray-100">
      <section className="flex flex-col items-center px-4 sm:px-6 lg:px-8 w-full max-w-5xl z-10">
        <motion.div
          ...
          className="">
          <motion.div
            className="flex flex-col md:flex-row items-center justify-between w-full my-8 md:my-1"
          ...
          <motion.div
            variants={itemVariants}
            className="w-full mt-10 md:mt-16 space-y-12 text-left bg-gray-800 bg-opacity-70 p-6 sm:p-8 md:p-10 rounded-xl shadow-2xl">

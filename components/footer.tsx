...
export default function Footer() {
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="mt-auto flex w-full flex-wrap items-center justify-center gap-x-4 gap-y-2 border-t bg-background p-6 text-sm text-muted-foreground md:justify-start"
    >
